                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                //storing images into sqlite database
                                RaisedBtn(
                                    ...
                                    onPressed: () async {
                                      ...
                                      DatabaseHelper.db
                                          ...
                                          attachmentname: '${item.patient.displayName ?? ''}' + "_" + '${formatted}'+'_'+ basename('${image}') + "_" ,
                                  ...
                                  onPressed: () async {
                                    ...
                                    for (int i = 0; i < paths.keys
                                      ...
                                      DatabaseHelper.db
                                          ...
                                          // dictationLocalId:
                                          //     '',
                                          attachmentname: '${item.patient.displayName ?? ''}' + "_" +  '${formatted}'+'_'+ ('${paths.keys.toList()[imageIndex]}'),
                                          attachmenttype: AppStrings.imageFormat,
                                          // "_" +
                        ...
                        Column(
                            ...
                            children: [
                              ...
                              RaisedBtn(
                                  ...
                                  onPressed: () {DatabaseHelper.db.delteImages();},
